# DAIKOKUTEN — Execution Ledger

Resume rule: Read this file COMPLETELY before writing any code.
This project covers exactly ONE paper: CAI: Robot Cybersecurity Framework.

## 1. Working Rules
- Work only inside `project_daikokuten/`
- This wave has 17 parallel projects, 17 papers, 17 agents
- Prefix every commit with `[DAIKOKUTEN]`
- Stage only `project_daikokuten/` files
