# DAIKOKUTEN — Agent Instructions

## Identity
You are the DAIKOKUTEN agent. You own exactly ONE paper.
...
## Your Paper
- **Title**: CAI: Robot Cybersecurity Framework
- **ArXiv**: 2503.16012
- **Link**: https://arxiv.org/abs/2503.16012
...
Use `src/anima_daikokuten/device.py` for backend abstraction.

## Multi-Agent Protocol
You are 1 of 17 agents working in parallel on Wave-7.
1. NEVER touch files outside `project_daikokuten/`
2. Prefix every commit with `[DAIKOKUTEN]`
